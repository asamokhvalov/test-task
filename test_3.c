...
/*
    ...
    Trying to read and write block out of sequence.
*/
...
int main (void)
{
    ...
    // read block 1
    unsigned char * addr_block_1 = &(memPool);
    addr_block_1 += SIZE_BLOCK;

    printf ("********** read block 1 **********\n");

    printf("addr_block_1 = %x\n", addr_block_1);

    PutMemBlock (&mPart, addr_block_1);
    test_print_mem_poll ();
    test_print_mPart (&mPart);

    printf ("********** write freed block **********\n");
